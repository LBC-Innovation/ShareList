...
import { Layout, Typography, Button, Tag, Flex, Card, Skeleton, Alert, Grid } from 'antd'
        ...
        {canAdd && (
          <Button
            ...
            style={{
              ...
              border: 'none', borderRadius: '10px', height: '44px', padding: '0 20px',
                  ...
                  <Flex vertical gap={12}>
                    ...
                    <Flex justify="space-between" align="center" gap={8}>
                      ...
                      <Button
                        ...
                        style={{ background: 'rgba(56, 189, 248, 0.15)', border: '1px solid rgba(56, 189, 248, 0.3)', color: '#38BDF8', borderRadius: '8px', height: '36px', padding: '0 14px', fontWeight: 600, fontSize: '13px' }}
                      >
                        Manage
                      </Button>
                    </Flex>
