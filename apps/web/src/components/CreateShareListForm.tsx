/**
 * CreateShareListForm — shared create flow used on New ShareList and the Lists accordion.
 *
 * Flow:
...
import { Typography, Button, Flex, Space, Divider, Select, Spin, Empty, Input, notification } from 'antd'
import {
  CheckCircleOutlined,
  LoadingOutlined,
  ArrowRightOutlined,
